package org.deeplearning4j.examples.kaggle.titanic;
...
//        normalizer.transform(verifyData);         //Apply normalization to the test data. This is using statistics calculated from the *training* set
        ...
        String outputPath = System.getProperty("user.dir")+"/dl4j-examples//src/main/resources/kaggle/titanic/output.csv";
